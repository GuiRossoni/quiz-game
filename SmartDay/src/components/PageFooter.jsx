			...
			<nav>
				<ul className='flex gap-4'>
					<li className='relative'>
						<button title='Informações' className={`align-middle relative z-20 hover:scale-105 p-1.5 bg-white rounded-md ${showInfo ? 'scale-110' : ''}`} onClick={() => handleClick(true)}>
							{
								alert
					...
					<li>
						<button title={sound ? 'Mudo' : 'Ligar som'} className='align-middle hover:scale-105 p-1.5 bg-white rounded-md'>
							{
								sound
