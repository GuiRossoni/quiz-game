...
export default function JsxForm ({ handleInputs, nowQueries }) {
	...
	const WILCARDS = [
		{ name: 'Pular pergunta', icon: <BsSkipEndFill color='white' className='text-2xl' />, amount: 1 },
		{ name: 'Eliminar duas respostas erradas', icon: <Image src={fiftyImg.src} alt="fifty fifty" width={23} height={23} />, amount: 1 },
		{ name: 'Vidas', icon: <FaHeart color='white' className='text-2xl' />, amount: 3 }
	]
		...
		<>
			<div className='flex gap-2 sm:gap-5 flex-col'>
				<fieldset className='p-1'>
					<legend className='text-lg font-semibold mb-2'>Coringas</legend>
				...
				<fieldset className='p-1 relative'>
					<legend className='text-lg font-semibold mb-2'>Perguntas</legend>
				...
				<fieldset className='p-1 relative'>
					<legend className='text-lg font-semibold mb-2'>Tempo</legend>

					<div className="cntr shadow-sm !left-15" >
			...
			<fieldset>
				<legend className='text-lg font-semibold mb-2 mx-1'>Categorias</legend>
